	...
	return (
		<div className="flex flex-col min-h-[300dvh]">
			...
			<section className="min-h-dvh w-full bg-neo-peach flex flex-col items-center justify-center border-b-8 border-neo-black py-20 px-6 text-center">
				<h2 className="text-5xl font-black tracking-tighter sm:text-7xl lg:text-8xl text-neo-black max-w-4xl leading-[1.1] mb-8 animate-pop-in" dangerouslySetInnerHTML={{ __html: t("landing.feature1.title").replace(" ", "<br className=\"hidden sm:block\" /> ") }}>
				</h2>
				...
				<div className="relative w-full max-w-md aspect-square flex items-center justify-center mb-16 animate-pop-in-delay-2">
					<div className="w-64 h-64 bg-neo-orange rounded-[30%] border-2 border-neo-black shadow-[2px_2px_0px_#1a1510] flex items-center justify-center relative hover:rounded-[50%] transition-all duration-500 z-10">
			...
			<section className="min-h-dvh w-full bg-neo-orange flex flex-col items-center justify-center py-20 px-6 text-center">
				<h2 className="text-5xl font-black tracking-tighter sm:text-7xl lg:text-8xl text-neo-black max-w-4xl leading-[1.1] mb-8" dangerouslySetInnerHTML={{ __html: t("landing.feature2.title") }}>
				</h2>
				...
				<div className="relative w-full max-w-md aspect-square flex flex-col items-center justify-center mb-16">
					<div className="w-56 h-auto bg-white border-2 border-neo-black shadow-[2px_2px_0px_#1a1510] relative rounded-t-full flex flex-col items-center pt-16 pb-12 z-0">
						{/* Eyes */}
						...
						{/* Book */}
						<div className="w-40 h-48 bg-[#2d2112] border-2 border-neo-black flex items-center justify-center absolute -bottom-10 shadow-[2px_2px_0px_#1a1510] text-neo-peach text-4xl z-20">
							♥
						</div>
						{/* Skirt */}
